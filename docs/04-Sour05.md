...
- no significant difference in ratings between the 8% skim milk and 8% whole milk comparison (t = 0.76, p = 0.454)    
- Ratings between the 8% skim milk and 8% water were significantly different (t = 2.8, p = 0.0045)  
- Ratings between the 8% whole milk and 8% water were marginally different (t = 1.433, p = 0.08)  

-  no significant difference in ratings between the 17% skim milk and 17% whole milk comparison (t = -0.561, p = 0.58)  
- Ratings between the 17%% skim milk and 17%% water were significantly different (t = 3.753, p = 0.0045)  
- Ratings between the 17% whole milk and 17% water were significantly different (t = 3.276, p = 0.08) 
...
- no discrimination seen between when 8% skim milk and 8% whole milk was added to coffee (R Index = 0.5, p < 0.01)  
...
- discrimination seen between when 8% skim milk and 8% water was added to coffee (R Index = 0.63, 0.01 $\le$ p $\le$ 0.05)  
...
- no difference between 8% skim and whole milk (t = 0.55, p = 0.59)
- marginal reduction in sourness between 8% skim and 8% water ratings (t = 2.12, p = 0.06655)  
