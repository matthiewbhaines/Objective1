...
- discrimination seen between when 8% skim milk and 8% water was added to coffee (R Index = `r round(as.numeric(water10S8C)[1], 2)`, p $\leq$ **0.05**)  
...
describe(Study1Meta)[2,] %>% select(mean, sd, median, min, max) #age

Study1Meta %>% count(gender) # 11 males, 19 females

Study1Meta %>% filter(consumption == "6")
