...
Milk10S8CSour <- RIndexV2(brew10closedsour %>% select(comparison_19_v_21_more_sour, confidence) %>% count(comparison_19_v_21_more_sour, confidence))
```
...
Milk10S17CSour <- RIndexV2(brew10closedsour %>% select(comparison_13_v_15_more_sour, confidence_15) %>% count(comparison_13_v_15_more_sour, confidence_15))
```
...
Milk10RSour <- tibble(
  ...
  Condition = "Closed",
  Rindex = c(Milk10S8CSour$RIND_S, Milk10S8CSour$RIND_N, Milk10S17CSour$RIND_S, Milk10S17CSour$RIND_N),
...
study2closedMilkRViz <- Milk10RSour %>% 
  ...
  geom_text(data = Milk10RSour, aes(Sample, Rindex, label = Addition), vjust = 1) 
```
...
water10S8CSour <- RIndexV2(brew10closedsour %>% select(comparison_20_v_23_more_sour, confidence_23) %>% 
  group_by(comparison_20_v_23_more_sour) %>% 
  mutate(confidence_23 = factor(confidence_23, levels = c(1,2,3))) %>% 
  count(confidence_23, .drop = F) %>% arrange(desc(comparison_20_v_23_more_sour)))

water10W8CSour <- RIndexV2(brew10closedsour %>% select(comparison_22_v_24_more_sour, confidence_24) %>% 
  group_by(comparison_22_v_24_more_sour) %>% 
  mutate(confidence_24 = factor(confidence_24, levels = c(1,2,3))) %>% 
  count(confidence_24, .drop = F) %>% arrange(desc(comparison_22_v_24_more_sour)))
...
water10S17CSour <- RIndexV2(brew10closedsour %>% select(comparison_14_v_17_more_sour, confidence_17) %>% 
  group_by(comparison_14_v_17_more_sour) %>% 
  mutate(confidence_17 = factor(confidence_17, levels = c(1,2,3))) %>% 
  count(confidence_17, .drop = F) %>% arrange(desc(comparison_14_v_17_more_sour)))
  
water10W17CSour <-  RIndexV2(brew10closedsour %>% select(comparison_16_v_18_more_sour, confidence_18) %>% 
  group_by(comparison_16_v_18_more_sour) %>% 
  mutate(confidence_18 = factor(confidence_18, levels = c(1,2,3))) %>% 
  count(confidence_18, .drop = F) %>% arrange(desc(comparison_16_v_18_more_sour)))
...
Water10RSour <- tibble( #from 02072025
  Sample = factor(c(rep(c("S18","S17"), 4))),
  ...
  Condition = "Closed",
  Rindex = c(water10S8CSour$RIND_S, water10S8CSour$RIND_N, water10W8CSour$RIND_S, water10W8CSour$RIND_N,
             water10S17CSour$RIND_S, water10S17CSour$RIND_N, water10W17CSour$RIND_S, water10W17CSour$RIND_N),
...
compareE <- Water10RSour %>% filter(Sig %in% "#B22222")
...
study2closedWaterRViz <- Water10RSour %>% 
  ...
  theme(panel.grid.major = element_blank(),
        ...
        strip.background.y = element_blank(),
        strip.text.y = element_blank()) +
  geom_text(data = Water10RSour, aes(Comparison, Rindex, label = Addition),
            vjust = 1) 
...
Milk10S8OSour <- RIndexV2(df10openedSour %>% select(comparison_19_v_21_more_sour, confidence) %>% count(comparison_19_v_21_more_sour, confidence)) 
...
Milk10S17OSour <- RIndexV2(df10openedSour %>% select(comparison_13_v_15_more_sour, confidence_15) %>% count(comparison_13_v_15_more_sour, confidence_15))
```
...
Milk10ROpenSour <- tibble(
  ...
  Percent = rep(factor(c("8% Addition", "17% Addition"),
                   levels = c("8% Addition", "17% Addition")), each = 2),
  Condition = "Opened",
  Rindex = c(Milk10S8OSour$RIND_S, Milk10S8OSour$RIND_N, Milk10S17OSour$RIND_S, Milk10S17OSour$RIND_N),
  Critical = as.numeric(Rcriti(length(df10openedSour$participant), length(df10openedSour$participant), 0.05, 2)[2]),
  Signal = rep(c("Signal", "Noise"), 2),
  Sig = ifelse(abs(Rindex) >= Critical & Signal == "Signal", "#B22222",
               ifelse(abs(Rindex) >= Critical & Signal == "Noise", "white",
                      "#888888")),
...
compareJ <- Milk10ROpenSour %>% filter(Sig == "#B22222")
...
study2OpenMilkRViz <- Milk10ROpenSour %>%   
  ...
  theme(panel.grid.major = element_blank(),
        ...
        axis.text.x = element_blank(),
        axis.ticks.x = element_blank()) +
  geom_text(data = Milk10ROpenSour, aes(Sample, Rindex, label = Addition), vjust = 1) +
  geom_text(data = Milk10ROpenSour[4,], aes(Sample, Rindex, label = Addition), vjust = -1)
...
water10S8OSour <- RIndexV2(df10openedSour %>% select(comparison_20_v_23_more_sour, confidence_23) %>% 
  group_by(comparison_20_v_23_more_sour) %>% 
  mutate(confidence_23 = factor(confidence_23, levels = c(1,2,3))) %>% 
  count(confidence_23, .drop = F) %>% arrange(desc(comparison_20_v_23_more_sour)))

water10W8OSour <-RIndexV2(df10openedSour %>% select(comparison_22_v_24_more_sour, confidence_24) %>% 
  group_by(comparison_22_v_24_more_sour) %>% 
  mutate(confidence_24 = factor(confidence_24, levels = c(1,2,3))) %>% 
  count(confidence_24, .drop = F) %>% arrange(desc(comparison_22_v_24_more_sour)))
...
water10S17OSour <- RIndexV2(df10openedSour %>% select(comparison_14_v_17_more_sour, confidence_17) %>% 
  group_by(comparison_14_v_17_more_sour) %>% 
  mutate(confidence_17 = factor(confidence_17, levels = c(1,2,3))) %>% 
  count(confidence_17, .drop = F) %>% arrange(desc(comparison_14_v_17_more_sour)))

water10W17OSour <- RIndexV2(df10openedSour %>% select(comparison_16_v_18_more_sour, confidence_18) %>% 
  group_by(comparison_16_v_18_more_sour) %>% 
  mutate(confidence_18 = factor(confidence_18, levels = c(1,2,3))) %>% 
  count(confidence_18, .drop = F) %>% arrange(desc(comparison_16_v_18_more_sour)))
...
Water10ROpenedSour <- tibble( #from 02072025
  Sample = factor(c(rep(c("S18","S17"), 4))),
  Name = c("water10S8C", "water10S8C", "water10W8C", "water10W8C",
             "water10S17C", "water10S17C", "water10W17C", "water10W17C"),
  Percent = rep(factor(c("8% Addition", "17% Addition"),
                   levels = c("8% Addition", "17% Addition")), each = 4),
  Condition = "Closed",
  Rindex = c(water10S8OSour$RIND_S, water10S8OSour$RIND_N, water10W8OSour$RIND_S, water10W8OSour$RIND_N,
             water10S17OSour$RIND_S, water10S17OSour$RIND_N, water10W17OSour$RIND_S, water10W17OSour$RIND_N),
  Signal = rep(c("Signal", "Noise"), 4),
...
compareK <- Water10ROpenedSour %>% filter(Sig %in% "#B22222")

rcritical_10WOpenedSour <- Water10ROpenedSour %>% filter(Percent == "8% Addition")

study2openedWaterRViz <- Water10ROpenedSour %>%   filter(Rindex >= 0.50) %>% 
  ggplot(aes(x = Comparison, y = Rindex, fill = Sig)) +
  geom_col(color = "black") +
  facet_grid(~Percent) +  
  scale_fill_manual(breaks = sig_levels, values = sig_levels) +
  ...
  theme(panel.grid.major = element_blank(),
        ...
        strip.background.y = element_blank(),
        strip.text.y = element_blank()) +
  geom_text(data = Water10ROpenedSour, aes(Comparison, Rindex, label = Addition),
            vjust = 1) 
```
