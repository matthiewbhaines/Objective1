...
- discrimination seen between when water and milk was added to the cold brew (see Figure \@ref(fig:study2ClosedWaterRatingsViz))
  + the R index analysis showed discrimination, however only the ratings in the 8% skim milk v. water comparison were significant, p = **`r round(t.test(brew10closedsour$sourness_23, brew10closedsour$sourness_20, paired = TRUE, alternative = "greater")$p.value, 4)`**
